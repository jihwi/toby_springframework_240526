...
public class UserDaoJdbc implements UserDao{
    ...
    public void add(User user) {
        jdbcTemplate.update("insert into users values (?,?,?,?,?,?, ?)", user.getId(), user.getName(), user.getPassword(), user.getLevel().getValue(), user.getLogin(), user.getRecommend(), user.getEmail());
    }
